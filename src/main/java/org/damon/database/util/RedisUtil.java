...
public class RedisUtil {
    ...
    private static final String LIST_EXCEPTION = "class:RedisUtils method:lSet() => Exception {}";
...
//        redisTemplate
    ...
    public <T> List<T> lGet(String key, long start, long end, Class<T> t) {
        try {
            ...
            if(CollUtil.isNotEmpty(range)){
                range.forEach(d ->list.add(BeanUtil.toBean(d,t)));
                return list;
            }
        } catch (Exception e) {
            log.error("class:RedisUtils method:lGet() => Exception {}", e.getMessage());
    ...
    public boolean lSet(String key, Object value) {
        try {
            ...
            log.error(LIST_EXCEPTION, e.getMessage());
        }
        return false;
    }
    ...
    private <T> T fromJson(Object json, Class<T> clazz) {
        ...
        return JSONUtil.toBean(JSONUtil.toJsonStr(json), clazz);
    }
}